...
public class PlayList {
    ...
    public static PlayList getSongsFromFile( String fileName ) throws IOException {
        ...
        try{
            ...
            while((line = in.readLine())!= null){
                ...
                Song add = new Song(song[0], song[1], song[2]);
    ...
    public void writeSongsToFile(String fileName) throws IOException{
        try{
            OutputStreamWriter toilet = new OutputStreamWriter(new FileOutputStream(fileName));
            
            for(int i = 0; i < this.getSize(); i++){
                toilet.write(this.songs[i].toString() + "\n");
                toilet.flush();
            }
